...
import com.example.applicationparking.Model.UpdateProfile;
import com.example.applicationparking.Model.User;
import com.example.applicationparking.URL.url;
import com.example.applicationparking.serverresponse.ImageResponse;
import com.example.applicationparking.strictmode.StrictModeClass;
...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user=new User();
        user=(com.example.applicationparking.Model.User) getIntent().getSerializableExtra("User");
